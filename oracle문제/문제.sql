...
SELECT EMPLOYEE_ID AS 사원번호, LAST_NAME AS 이름, JOB_ID AS 담당업무,  SALARY AS 급여, HIRE_DATE AS 입사일자, DEPARTMENT_ID AS 부서번호 FROM EMPLOYEES WHERE HIRE_DATE >= '1995-01-01';
